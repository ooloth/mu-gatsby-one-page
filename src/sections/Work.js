...
// class WorkCombined extends React.Component {
//   state = { projects: null, operaIsChecked: true, websitesIsChecked: true }

//   componentDidMount = () => {
//     // Merge the opera and website arrays (alternate categories)
//     const mergedProjects = this.alternateCategories()
...
//           this.filterByCategory({ opera: true, websites: this.state.websitesIsChecked })
//         } else if (!event.target.checked && this.state.websitesIsChecked) {
//           this.filterByCategory({ opera: false, websites: true })
//         } else {
//           this.filterByCategory({ opera: true, websites: true })
//         }
//         break

//       case `websites`:
//         if (event.target.checked) {
//           this.filterByCategory({ opera: this.state.operaIsChecked, websites: true })
//         } else if (!event.target.checked && this.state.operaIsChecked) {
//           this.filterByCategory({ opera: true, websites: false })
//         } else {
//           this.filterByCategory({ opera: true, websites: true })
//         }
//         break
...
//   filterByCategory = ({
//     opera = this.state.operaIsChecked,
//     websites = this.state.websitesIsChecked
//   }) => {
//     let filteredProjects
//     if (this.props.operaIsChecked && this.props.websitesIsChecked) {
//       this.updateVisibleProjects(this.props.projects, this.state.limit)
//     } else if (this.props.operaIsChecked && !this.props.websitesIsChecked) {
//       filteredProjects = this.props.projects.filter(project => {
//         return project.node.category === 'Opera' || project.node.category === 'opera'
//       })
//       this.updateVisibleProjects(filteredProjects, this.state.limit)
//     } else if (!this.props.operaIsChecked && this.props.websitesIsChecked) {
//       filteredProjects = this.props.projects.filter(project => {
...
//       this.updateVisibleProjects(filteredProjects, this.state.limit)
//     } else {
//       console.log('Something weird in the render method of <Projects />...')
//     }
...
//     if (this.state.limit < this.state.total) {
//       if (this.state.limit + 5 <= this.state.total) {
//         this.updateVisibleProjects(this.state.filteredProjects, this.state.limit + 5)
//         // this.setState({ limit: this.state.limit + 5 })
//         // } else if (this.state.limit + 5 === this.state.total) {
//         // this.updateVisibleProjects(this.state.filteredProjects, this.state.limit + 5)
//         // this.setState({ limit: this.state.limit + 5, allLoaded: true })
//       } else {
//         this.updateVisibleProjects(this.state.filteredProjects, this.state.total)
//         // this.setState({ limit: this.state.total, allLoaded: true })
//       }
//     }
//   }

//   updateVisibleProjects = (filteredProjects, limit = this.state.limit) => {
//     console.log(`filteredProjects`, filteredProjects)
//     // if (filteredProjects === null) filteredProjects = this.state.filteredProjects

//     const visibleProjects = filteredProjects.filter((project, index) => {
//       if (index < this.state.limit) return project
//     })

//     // Hide the "load more" button if all the projects are now loaded
//     const allLoaded = limit >= this.state.total ? true : false
